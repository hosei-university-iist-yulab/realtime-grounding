...
class UCILoader(DatasetLoader):
    ...
    SUPPORTED_DATASETS = {
        ...
        "sml2010": {
            "name": "SML2010 Smart Home Sensors",
            "url": "https://archive.ics.uci.edu/static/public/274/sml2010.zip",
            "description": "Smart home temperature (15-min)",
            "filename": "sml2010_clean.csv",
            "sep": ",",
            "value_column": "Temperature_Comedor_Sensor",
            "date_columns": ["date"],
            "n_samples": 2764,
        },
        "occupancy_detection": {
            ...
            "description": "Smart office/home CO2 (1-min)",
            "filename": "occupancy_clean.csv",
            "sep": ",",
            "value_column": "CO2",
            "date_columns": ["date"],
            "n_samples": 20560,
        ...
        "air_quality": {
            ...
            "description": "IoT air-quality gas sensor (1-h)",
            "filename": "air_quality_clean.csv",
            "sep": ",",
            "value_column": "C6H6(GT)",
            "date_columns": ["date"],
            "n_samples": 8991,
        },
        "electricity_loads": {
            "name": "UCI Electricity Load Diagrams (consumer MT_200)",
            "url": "https://archive.ics.uci.edu/static/public/321/electricityloaddiagrams20112014.zip",
            "description": "Consumer electricity load (15-min)",
            "filename": "eld_clean.csv",
            "sep": ",",
            "value_column": "value",
            "date_columns": ["date"],
            "n_samples": 140240,
